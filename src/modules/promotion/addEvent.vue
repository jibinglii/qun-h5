<template>
  <div class>
    ...
    <x-cell-group>
      ...
      >
        <template slot="value">
          <van-button slot="button" size="small" type="primary" @click="select(item.id)">选择</van-button>
        </template>
      </x-cell>
    </x-cell-group>
    ...
    <div class="btn">
      <van-button type="primary" hairline size="large" @click="next()">添加文案</van-button>
    </div>
  </div>
</template>
