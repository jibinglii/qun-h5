<template>
  <div class="resource">
    ...
    <x-cell-group>
      ...
      <van-field label="名称" v-model="params.name" placeholder="请输入资源名称"></van-field>
      <van-field label="规格" v-model="params.size" placeholder="如群人数/粉丝数/日访问量"></van-field>
      <van-field
        readonly
        clickable
        label="区域"
    ...
    <x-cell-group>
      <x-checkbox title="资源类型" type="radio" :data="resource" v-model="params.category"></x-checkbox>
    </x-cell-group>
    <x-cell-group>
      <van-field
        v-model="params.desc"
    ...
    <x-cell-group>
      <x-uploader title="资源截图" v-model="params.attachment" :limit="2"></x-uploader>
    </x-cell-group>
